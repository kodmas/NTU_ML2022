...
Original file is located at
    https://colab.research.google.com/drive/1AUU0ddjteiuv-x4qcA4nVyDcircFyhdR
...
class Discriminator(nn.Module):
    ...
    def __init__(self, in_dim, feature_dim=64):
        ...
        self.l1 = nn.Sequential(
            ...
            self.conv_bn_lrelu(feature_dim * 8, feature_dim * 16),               #(batch, 3, 4, 4)
    ...
    def train(self):
        ...
        for e, epoch in enumerate(range(self.config["n_epoch"])):
            ...
            for i, data in enumerate(progress_bar):
                ...
                # layers = [self.D.l1[i][0] for i in range(2 , 6)]

                # for layer in layers:
                #   grad = layer.weight.grad
                #   print(layer,":", math.log10(grad.view(grad.size(0),-1).norm(2,dim = 1).mean().item()))
            ...
            # Show final image.
            if (epoch == self.config["n_epoch"] -1):
...
trainer.inference(f'{workspace_dir}/checkpoints/2022-04-22_07-52-41_WGAN/G_0.pth') # you have to modify the path when running this line
