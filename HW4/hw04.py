...
class Classifier(nn.Module):
	def __init__(self, d_model=240, n_spks=600, dropout=0.1):
		...
		self.encoder_layer = ConformerBlock(dim = d_model,
    dim_head = 64,
    heads = 2,
    ff_mult = 4,
    conv_expansion_factor = 9,
    conv_kernel_size = 31,
    attn_dropout = 0.1,
    ff_dropout = 0.1,
    conv_dropout = 0.1)
	
		#self.encoder = nn.TransformerEncoder(self.encoder_layer, num_layer = 5)
